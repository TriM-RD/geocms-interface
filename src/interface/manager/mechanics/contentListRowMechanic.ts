...
export namespace Manager.Mechanic{
  ...
  export class ContentListRowMechanic extends MechanicAbstract {
    ...
    private forEachElement (data: any) : ObjectTemplate[] {
      ...
      data.forEach((_list: any) => {
        _temp = _temp.concat(_list.map((_object: any) => {
          return new ObjectTemplate(RegionEnum.ContentList, ObjectTypeEnum.ContentListRow, SubObjectTypeEnum.ParentObject, ActionTypeEnum.Click, this.reStructure(_object.Stats))
        }))
      })
      return _temp
    }
    ...
    protected SubscribeConditions (): void {
      RegionType.RegionTypes[RegionEnum.ContentListRow].ObjectTypes[ObjectTypeEnum.Button].SubscribeLogic(this.Button.bind(this))
    }

    public UnsubscribeConditions () {
      RegionType.RegionTypes[RegionEnum.ContentListRow].ObjectTypes[ObjectTypeEnum.Button].NullifyLogic()
    }
