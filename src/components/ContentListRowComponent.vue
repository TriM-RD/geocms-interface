...
import { Manager } from '@/interface/manager/mechanics/contentListRowMechanic'
...
export default class ContentListRowComponent extends Vue {
  mechanic: MechanicAbstract = new Manager.Mechanic.ContentListRowMechanic()
  ...
  objectTemplates = this.mechanic.InitSet(
    [
      new ObjectTemplate(RegionEnum.ContentListRow, ObjectTypeEnum.Button, SubObjectTypeEnum.Right, ActionTypeEnum.Click, {
        [StatTypeEnum.Label]: StatType.StatTypes[StatTypeEnum.Label]().CreateStat().InitData('Pregledaj'),
